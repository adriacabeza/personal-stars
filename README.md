...
|  | Name 	|  Description 	| Author  	|  Stars 	|
|---	|---	|---	|---	|---	|
| 1 |  [Skeleton](https://github.com/dhg/Skeleton) | Skeleton: A Dead Simple, Responsive Boilerplate for Mobile-Friendly Development | dhg | 18710 |
| 2 |  [handcalcs](https://github.com/connorferster/handcalcs) | Python library for converting Python calculations into rendered latex. | connorferster | 4939 |
| 3 |  [water.css](https://github.com/kognise/water.css) | A drop-in collection of CSS styles to make simple websites just a little nicer | kognise | 7356 |
...
|  | Name 	|  Description 	| Author  	|  Stars 	|
|---	|---	|---	|---	|---	|
| 1 |  [SENet](https://github.com/hujie-frank/SENet) | Squeeze-and-Excitation Networks | hujie-frank | 3032 |
...
|  | Name 	|  Description 	| Author  	|  Stars 	|
|---	|---	|---	|---	|---	|
| 1 |  [opa](https://github.com/open-policy-agent/opa) | An open source, general-purpose policy engine. | open-policy-agent | 7314 |
| 2 |  [ntfy](https://github.com/binwiederhier/ntfy) | Send push notifications to your phone or desktop using PUT/POST | binwiederhier | 3515 |
| 3 |  [aws-vault](https://github.com/99designs/aws-vault) | A vault for securely storing and accessing AWS credentials in development environments | 99designs | 6898 |
| 4 |  [docker-slim](https://github.com/docker-slim/docker-slim) | DockerSlim (docker-slim): Don&#39;t change anything in your Docker container image and minify it by up to 30x (and for compiled languages even more) making it secure too! (free and open source) | docker-slim | 15369 |
| 5 |  [tsdb-layer](https://github.com/richardartoul/tsdb-layer) | Time Series and FoundationDB. Millions of writes/s and 10x compression in under 2,000 lines of Go. | richardartoul | 466 |
| 6 |  [gobuster](https://github.com/OJ/gobuster) | Directory/File, DNS and VHost busting tool written in Go | OJ | 6747 |
| 7 |  [chaos-controller](https://github.com/DataDog/chaos-controller) | Datadog chaos controller for Kubernetes | DataDog | 121 |
| 8 |  [traitor](https://github.com/liamg/traitor) | :arrow_up: :skull_and_crossbones: :fire: Automatic Linux privesc via exploitation of low-hanging fruit e.g. gtfobins, pwnkit, dirty pipe, +w docker.sock | liamg | 5465 |
| 9 |  [cilium](https://github.com/cilium/cilium) | eBPF-based Networking, Security, and Observability | cilium | 13378 |
| 10 |  [Gorecon](https://github.com/devanshbatham/Gorecon) | Gorecon is a All in one Reconnaissance Tool , a.k.a swiss knife for Reconnaissance  , A tool that every pentester/bughunter might wanna consider into their arsenal | devanshbatham | 252 |
| 11 |  [jackal](https://github.com/ortuman/jackal) | 💬 Instant messaging server for the Extensible Messaging and Presence Protocol (XMPP). | ortuman | 1349 |
| 12 |  [stratus-red-team](https://github.com/DataDog/stratus-red-team) | :cloud: :zap: Granular, Actionable Adversary Emulation for the Cloud | DataDog | 1140 |
| 13 |  [k9s](https://github.com/derailed/k9s) | 🐶 Kubernetes CLI To Manage Your Clusters In Style! | derailed | 18421 |
| 14 |  [stern](https://github.com/wercker/stern) | ⎈ Multi pod and container log tailing for Kubernetes | wercker | 6320 |
| 15 |  [gotraining](https://github.com/ardanlabs/gotraining) | Go Training Class Material : | ardanlabs | 10846 |
...
| 8 |  [DIGITS](https://github.com/NVIDIA/DIGITS) | Deep Learning GPU Training System | NVIDIA | 4071 |
...
|  | Name 	|  Description 	| Author  	|  Stars 	|
|---	|---	|---	|---	|---	|
| 1 |  [marshalsec](https://github.com/mbechler/marshalsec) |  | mbechler | 2808 |
| 2 |  [byte-buddy](https://github.com/raphw/byte-buddy) | Runtime code generation for the Java virtual machine. | raphw | 5240 |
...
| 4 |  [log4shell-vulnerable-app](https://github.com/christophetd/log4shell-vulnerable-app) | Spring Boot web application vulnerable to Log4Shell (CVE-2021-44228). | christophetd | 1022 |
| 5 |  [caffeine](https://github.com/ben-manes/caffeine) | A high performance caching library for Java | ben-manes | 12557 |
...
| 3 |  [fastify](https://github.com/fastify/fastify) | Fast and low overhead web framework, for Node.js | fastify | 25418 |
| 4 |  [volkswagen](https://github.com/auchenberg/volkswagen) | :see_no_evil: Volkswagen detects when your tests are being run in a CI server, and makes them pass. | auchenberg | 12542 |
| 5 |  [statsd](https://github.com/statsd/statsd) | Daemon for easy but powerful stats aggregation | statsd | 16727 |
| 6 |  [wifi-card](https://github.com/bndw/wifi-card) | 📶 Print a QR code for connecting to your WiFi (wificard.io) | bndw | 6096 |
| 7 |  [metrics](https://github.com/lowlighter/metrics) | 📊 An infographics generator with 30+ plugins and 200+ options to display stats about your GitHub account and render them as SVG, Markdown, PDF or JSON! | lowlighter | 8709 |
...
| 9 |  [readme.so](https://github.com/octokatherine/readme.so) | An online drag-and-drop editor to easily build READMEs | octokatherine | 3025 |
...
| 12 |  [cml](https://github.com/iterative/cml) | ♾️ CML - Continuous Machine Learning \| CI/CD for ML | iterative | 3532 |
| 13 |  [SingleFile](https://github.com/gildas-lormeau/SingleFile) | Web Extension for Firefox/Chrome/MS Edge and CLI tool to save a faithful copy of an entire web page in a single HTML file | gildas-lormeau | 9425 |
| 14 |  [react-redux-realworld-example-app](https://github.com/gothinkster/react-redux-realworld-example-app) | Exemplary real world application built with React + Redux | gothinkster | 5378 |
| 15 |  [bundle-wizard](https://github.com/aholachek/bundle-wizard) | Magically easy insight into the JavaScript loaded by a web app | aholachek | 658 |
...
| 7 |  [deep-text-recognition-benchmark](https://github.com/clovaai/deep-text-recognition-benchmark) | Text recognition (optical character recognition) with deep learning methods. | clovaai | 3085 |
...
|  | Name 	|  Description 	| Author  	|  Stars 	|
|---	|---	|---	|---	|---	|
| 1 |  [AWSome-Pentesting](https://github.com/pop3ret/AWSome-Pentesting) | My cheatsheet notes to pentest AWS infrastructure | pop3ret | 538 |
| 2 |  [aws-customer-security-incidents](https://github.com/ramimac/aws-customer-security-incidents) | A repository of breaches of AWS customers | ramimac | 253 |
| 3 |  [rocksdb_wiki](https://github.com/EighteenZi/rocksdb_wiki) |  | EighteenZi | 20 |
| 4 |  [the-book-of-secret-knowledge](https://github.com/trimstray/the-book-of-secret-knowledge) | A collection of inspiring lists, manuals, cheatsheets, blogs, hacks, one-liners, cli/web tools and more. | trimstray | 81593 |
| 5 |  [attacking-cloudgoat2](https://github.com/appsecco/attacking-cloudgoat2) | A step-by-step walkthrough of CloudGoat 2.0 scenarios. | appsecco | 124 |
| 6 |  [git-flight-rules](https://github.com/k88hudson/git-flight-rules) | Flight rules for git | k88hudson | 39367 |
| 7 |  [awesome-ebpf](https://github.com/zoidbergwill/awesome-ebpf) | A curated list of awesome projects related to eBPF. | zoidbergwill | 2617 |
| 8 |  [awesome-falsehood](https://github.com/kdeldycke/awesome-falsehood) | 😱 Falsehoods Programmers Believe in | kdeldycke | 19029 |
| 9 |  [awesome-actions](https://github.com/sdras/awesome-actions) | A curated list of awesome actions to use on GitHub | sdras | 20072 |
| 10 |  [Selfhosted-Google-Photos-Alternative](https://github.com/pluja/Selfhosted-Google-Photos-Alternative) | A complete guide on exiting Google, Amazon or any proprietary service Photos storage with all the features you would want. | pluja | 131 |
| 11 |  [cap-faq](https://github.com/henryr/cap-faq) | The CAP FAQ | henryr | 714 |
| 12 |  [modern-unix](https://github.com/ibraheemdev/modern-unix) | A collection of modern/faster/saner alternatives to common unix commands. | ibraheemdev | 24613 |
| 13 |  [Resources-for-Beginner-Bug-Bounty-Hunters](https://github.com/nahamsec/Resources-for-Beginner-Bug-Bounty-Hunters) | A list of resources for those interested in getting started in bug bounties | nahamsec | 8142 |
| 14 |  [awesome-illustrated-guides](https://github.com/searchableguy/awesome-illustrated-guides) | Awesome illustrated guides or children&#39;s books on technical topics. | searchableguy | 313 |
| 15 |  [python-horror-show](https://github.com/pablogsal/python-horror-show) | Strange and odd python snippets explained | pablogsal | 191 |
| 16 |  [OSCP](https://github.com/elzerjp/OSCP) |  | elzerjp | 9 |
| 17 |  [applied-ml](https://github.com/eugeneyan/applied-ml) | 📚 Papers &amp; tech blogs by companies sharing their work on data science &amp; machine learning in production. | eugeneyan | 21655 |
| 18 |  [awesome-grpc](https://github.com/grpc-ecosystem/awesome-grpc) | A curated list of useful resources for gRPC | grpc-ecosystem | 5804 |
| 19 |  [every-programmer-should-know](https://github.com/mtdvio/every-programmer-should-know) | A collection of (mostly) technical things every software developer should know about | mtdvio | 63719 |
| 20 |  [Front-End-Checklist](https://github.com/thedaviddias/Front-End-Checklist) | 🗂 The perfect Front-End Checklist for modern websites and meticulous developers | thedaviddias | 62473 |
| 21 |  [wer_are_we](https://github.com/syhw/wer_are_we) | Attempt at tracking states of the arts and recent results (bibliography) on speech recognition. | syhw | 1789 |
| 22 |  [bombs](https://github.com/bones-codes/bombs) | A few files for decompression bomb testing ––– | bones-codes | 129 |
| 23 |  [remotes](https://github.com/remote-es/remotes) | This is a repository listing companies which offer full-time remote jobs with Spanish contracts | remote-es | 530 |
| 24 |  [Learn-Vim](https://github.com/iggredible/Learn-Vim) | Learning Vim and Vimscript doesn&#39;t have to be hard. This is the guide that you&#39;re looking for 📖 | iggredible | 8798 |
| 25 |  [awesome-cbir-papers](https://github.com/willard-yuan/awesome-cbir-papers) | 📝Awesome and classical image retrieval papers | willard-yuan | 1475 |
| 26 |  [kahoot-winner](https://github.com/theusaf/kahoot-winner) | The source code for Kahoot Winner (app) | theusaf | 38 |
| 27 |  [Master-Thesis-Deep-Learning-and-Graph-Clustering-for-Maritime-Logistics](https://github.com/alvarorgaz/Master-Thesis-Deep-Learning-and-Graph-Clustering-for-Maritime-Logistics) | This is the thesis of my double master&#39;s degree in Data Science at KTH (Stockholm, Sweden) &amp; Aalto University (Helsinki, Finland). | alvarorgaz | 1 |
| 28 |  [machine-learning-interview](https://github.com/khangich/machine-learning-interview) | Machine Learning Interviews from FAANG, Snapchat, LinkedIn. I have offers from Snapchat, Coupang, Stitchfix etc. Blog: mlengineer.io. | khangich | 5850 |
| 29 |  [Deep-Learning-in-Production](https://github.com/ahkarami/Deep-Learning-in-Production) | In this repository, I will share some useful notes and references about deploying deep learning-based models in production. | ahkarami | 3811 |
| 30 |  [Traefik-v2-examples](https://github.com/DoTheEvo/Traefik-v2-examples) | Traefik v2 guide by examples | DoTheEvo | 479 |
...
|  | Name 	|  Description 	| Author  	|  Stars 	|
|---	|---	|---	|---	|---	|
| 1 |  [nikto](https://github.com/sullo/nikto) | Nikto web server scanner | sullo | 6190 |
| 2 |  [file-arranger](https://github.com/anhsirk0/file-arranger) | Simple &amp; capable Directory arranger/cleaner | anhsirk0 | 54 |
...
|  | Name 	|  Description 	| Author  	|  Stars 	|
|---	|---	|---	|---	|---	|
| 1 |  [mimikittenz](https://github.com/orlyjamie/mimikittenz) | A post-exploitation powershell tool for extracting juicy info from memory. | orlyjamie | 1732 |
...
|  | Name 	|  Description 	| Author  	|  Stars 	|
|---	|---	|---	|---	|---	|
| 1 |  [swiplwebtut](https://github.com/Anniepoo/swiplwebtut) | A tutorial for the swipl web framework | Anniepoo | 86 |
...
|  | Name 	|  Description 	| Author  	|  Stars 	|
|---	|---	|---	|---	|---	|
| 1 |  [pdoc](https://github.com/mitmproxy/pdoc) | API Documentation for Python Projects | mitmproxy | 1370 |
| 2 |  [tortoise-tts](https://github.com/neonbjb/tortoise-tts) | A multi-voice TTS system trained with an emphasis on quality | neonbjb | 1691 |
| 3 |  [refurb](https://github.com/dosisod/refurb) | A tool for refurbishing and modernizing Python codebases | dosisod | 1674 |
| 4 |  [autofaiss](https://github.com/criteo/autofaiss) | Automatically create Faiss knn indices with the most optimal similarity search parameters. | criteo | 360 |
| 5 |  [DTLN-aec](https://github.com/breizhn/DTLN-aec) | This Repostory contains the pretrained DTLN-aec model for real-time acoustic echo cancellation. | breizhn | 167 |
| 6 |  [checkov](https://github.com/bridgecrewio/checkov) | Prevent cloud misconfigurations and find vulnerabilities during build-time in infrastructure as code, container images and open source packages with Checkov by Bridgecrew. | bridgecrewio | 4831 |
| 7 |  [diagrams](https://github.com/mingrammer/diagrams) | :art: Diagram as Code for prototyping cloud system architectures | mingrammer | 26274 |
| 8 |  [cloudgoat](https://github.com/RhinoSecurityLabs/cloudgoat) | CloudGoat is Rhino Security Labs&#39; &#34;Vulnerable by Design&#34; AWS deployment tool | RhinoSecurityLabs | 1753 |
| 9 |  [YaLM-100B](https://github.com/yandex/YaLM-100B) | Pretrained language model with 100B parameters | yandex | 3085 |
| 10 |  [memray](https://github.com/bloomberg/memray) | Memray is a memory profiler for Python | bloomberg | 9492 |
| 11 |  [httpie](https://github.com/httpie/httpie) | 🥧 HTTPie for Terminal — modern, user-friendly command-line HTTP client for the API era. JSON support, colors, sessions, downloads, plugins &amp; more. | httpie | 24509 |
| 12 |  [Awesome-Bugbounty-Writeups](https://github.com/devanshbatham/Awesome-Bugbounty-Writeups) | A curated list of bugbounty writeups (Bug type wise) , inspired from https://github.com/ngalongc/bug-bounty-reference | devanshbatham | 2938 |
| 13 |  [log4j-shell-poc](https://github.com/kozmer/log4j-shell-poc) | A Proof-Of-Concept for the CVE-2021-44228 vulnerability. | kozmer | 1488 |
| 14 |  [rich](https://github.com/Textualize/rich) | Rich is a Python library for rich text and beautiful formatting in the terminal. | Textualize | 40513 |
| 15 |  [pip-audit](https://github.com/pypa/pip-audit) | Audits Python environments and dependency trees for known vulnerabilities | pypa | 663 |
| 16 |  [itomate](https://github.com/kamranahmedse/itomate) | Automate your iTerm layouts and session setup | kamranahmedse | 308 |
| 17 |  [SSRFmap](https://github.com/swisskyrepo/SSRFmap) | Automatic SSRF fuzzer and exploitation tool | swisskyrepo | 2022 |
| 18 |  [git-imerge](https://github.com/mhagger/git-imerge) | Incremental merge for git | mhagger | 2503 |
| 19 |  [weird_proxies](https://github.com/GrrrDog/weird_proxies) | Reverse proxies cheatsheet | GrrrDog | 1470 |
| 20 |  [binance-trading-bot-new-coins](https://github.com/CyberPunkMetalHead/binance-trading-bot-new-coins) | This Binance trading bot detects new coins as soon as they are listed on the Binance exchange and automatically places sell and buy orders. It comes with trailing stop loss and other features. If you like this project please consider donating via Brave. | CyberPunkMetalHead | 1416 |
...
| 55 |  [RealSR](https://github.com/jixiaozhong/RealSR) | Real-World Super-Resolution via Kernel Estimation and Noise Injection | jixiaozhong | 615 |
...
| 92 |  [cookiecutter-pypackage](https://github.com/audreyfeldroy/cookiecutter-pypackage) | Cookiecutter template for a Python package. | audreyfeldroy | 3656 |
...
| 127 |  [searchly](https://github.com/AlbertSuarez/searchly) | 🎶 Song similarity search API based on lyrics | AlbertSuarez | 20 |
...
| 161 |  [hyperas](https://github.com/maxpumperla/hyperas) | Keras + Hyperopt: A very simple wrapper for convenient hyperparameter optimization | maxpumperla | 2142 |
...
| 196 |  [weather-player](https://github.com/AlbertSuarez/weather-player) | 🎵 Music playlist mixer using weather data | AlbertSuarez | 7 |
...
| 12 |  [genact](https://github.com/svenstaro/genact) | 🌀 A nonsense activity generator | svenstaro | 6628 |
...
|  | Name 	|  Description 	| Author  	|  Stars 	|
|---	|---	|---	|---	|---	|
| 1 |  [custom-easings-with-keyframes](https://github.com/mauriciabad/custom-easings-with-keyframes) | 🏃 Make custom non-cubic-bezier easings using keyframes and animations with this online css code generator. | mauriciabad | 15 |
